...
window.ECMIS.OrderMemoDocs["timebar_secgen"] = {
  ...
  "fields": [
    ...
    },
    {
      ...
      "label": "ตำแหน่งผู้ลงนาม",
      "type": "text",
      "hint": "เช่น กบค.กลุ่มงานบริหารคดีและบริหารทั่วไป",
      "placeholder": "ตำแหน่งผู้ลงนาม"
    }
  ],
  "prefill": {
